...
urlpatterns = [
    ...
    #Should have proper authentication and connection to projects
    ...
    path("orgarhythmus/projects/<int:project_id>/all_teams_for_this_project/", views.all_teams_for_this_project, name="all_teams_for_this_project", ), 
